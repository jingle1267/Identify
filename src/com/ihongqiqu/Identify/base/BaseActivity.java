...
public class BaseActivity extends AppCompatActivity {
    ...
    public void hideToolbar() {
        ObjectAnimator animator =
            ObjectAnimator.ofFloat(toolbar, "translationY", 0, -toolbar.getHeight()).setDuration(500);
    ...
    public void showToolbar() {
        ObjectAnimator animator =
            ObjectAnimator.ofFloat(toolbar, "translationY", -toolbar.getHeight(), 0).setDuration(500);
